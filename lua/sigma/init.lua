...
M.change_theme = require "sigma.change_theme"
...
M.cmd = function(cmd, print_error)
  -- check if sigma is running on windows and pipe the command through cmd.exe
...
M.reload_theme = require "sigma.reload_theme"

-- update sigma
M.update_sigma = require "sigma.updater.update"

-- create snapshot
M.snap_create = require "sigma.updater.snap_create"

-- checkout snapshot
M.snap_checkout = require "sigma.updater.snap_checkout"

-- delete snapshot
M.snap_delete = require "sigma.updater.snap_delete"

M.write_data = function(old_data, new_data)
  local file_fn = require("sigma").file
  local file = fn.stdpath "config" .. "/lua/custom/" .. "sigmarc.lua"
