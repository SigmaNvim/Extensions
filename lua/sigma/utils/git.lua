...
M.update_url = M.current_config.options.sigma.update_url or "https://github.com/sigma/sigma"
M.update_branch = M.current_config.options.sigma.update_branch or "main"
...
-- check if the sigma directory is a valid git repo
